...
StructuredCloneData::BuildClonedMessageDataForParent(
  ...
  ClonedMessageData& aClonedData)
{
  return BuildClonedMessageData<Parent>(aParent, *this, aClonedData);
}
...
StructuredCloneData::BuildClonedMessageDataForChild(
  ...
  ClonedMessageData& aClonedData)
{
  return BuildClonedMessageData<Child>(aChild, *this, aClonedData);
}

bool
StructuredCloneData::BuildClonedMessageDataForBackgroundParent(
  BackgroundParent* aParent,
  ClonedMessageData& aClonedData)
{
  return BuildClonedMessageData<BackgroundParent>(aParent, *this, aClonedData);
}

bool
StructuredCloneData::BuildClonedMessageDataForBackgroundChild(
  BackgroundChild* aChild,
  ClonedMessageData& aClonedData)
{
  return BuildClonedMessageData<BackgroundChild>(aChild, *this, aClonedData);
}
...
struct MemoryTraits<CopyMemory>
{
  ...
  static ProvideBuffer(const ClonedMessageData& aClonedData,
                       StructuredCloneData& aData)
  {
    const SerializedStructuredCloneBuffer& buffer = aClonedData.data();
...
StructuredCloneData::BorrowFromClonedMessageDataForParent(const ClonedMessageData& aClonedData)
{
  ...
  UnpackClonedMessageData<BorrowMemory, Parent>(aClonedData);
}
...
StructuredCloneData::BorrowFromClonedMessageDataForChild(const ClonedMessageData& aClonedData)
{
  ...
  // likewise on that thread.
  MOZ_ASSERT(NS_IsMainThread());
  UnpackClonedMessageData<BorrowMemory, Child>(aClonedData);
}

void
StructuredCloneData::BorrowFromClonedMessageDataForBackgroundParent(const ClonedMessageData& aClonedData)
{
  MOZ_ASSERT(BackgroundParent::IsOnBackgroundThread());
  UnpackClonedMessageData<BorrowMemory, Parent>(aClonedData);
}
...
{
  MOZ_ASSERT(NS_IsMainThread());
  UnpackClonedMessageData<CopyMemory, Parent>(aClonedData);
}
...
{
  MOZ_ASSERT(NS_IsMainThread());
  UnpackClonedMessageData<CopyMemory, Child>(aClonedData);
}
...
{
  MOZ_ASSERT(NS_IsMainThread());
  UnpackClonedMessageData<StealMemory, Parent>(aClonedData);
}
...
{
  MOZ_ASSERT(NS_IsMainThread());
  UnpackClonedMessageData<StealMemory, Child>(aClonedData);
}
...
void
StealFromClonedMessageDataForBackgroundChild(ClonedMessageData& aClonedData)
{
  UnpackClonedMessageData<StealMemory, Child>(aClonedData);
}
