...
public:
  ...
  bool BuildClonedMessageDataForChild(nsIContentChild* aChild,
                                      ClonedMessageData& aClonedData);
  bool BuildClonedMessageDataForBackgroundParent(BackgroundParent* aParent,
                                                 ClonedMessageData& aClonedData);
  bool BuildClonedMessageDataForBackgroundChild(BackgroundChild* aChild,
                                                ClonedMessageData& aClonedData);
...
protected:
  StructuredCloneData(TransferringSupport aSupportsTransferring)
